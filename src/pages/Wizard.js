                    ...
                    <div className="wizard-card">
                        <div className="wizard-card-header">
                            <div className="grid col-12">
                                <div className={classNames('col-4 tab register-tab', { 'selected-tab': activeTab === 'register' })} onClick={() => setActiveTab('register')}>
                                    <div className="icon">
                                        <i className="pi pi-sign-in"></i>
                                    </div>
                                    <div className="title">REGISTER</div>
                                </div>
                                <div className={classNames('col-4 tab tier-tab', { 'selected-tab': activeTab === 'tier' })} onClick={() => setActiveTab('tier')}>
                                    <div className="icon">
                                        <i className="pi pi-clone"></i>
                                    </div>
                                    <div className="title">CHOOSE TIER</div>
                                </div>
                                <div className={classNames('col-4 tab payment-tab', { 'selected-tab': activeTab === 'payment' })} onClick={() => setActiveTab('payment')}>
                                    <div className="icon">
